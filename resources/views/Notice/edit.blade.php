            ...
            <div class="card-body">
                <div class="row welcomecard">
                    <div class="col-12">
                        ...
                        <form class="custom-hover" action="{{route('notice.update',['id'=>$notice->id])}}" method="POST">
                            {{ csrf_field() }}
                            {{method_field('put')}}
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach($roles as $role)
                                            <div class="form-check form-check-inline">
                                                <input class="custom-checkbox form-check-input " name="roles[]" type="checkbox" id="{{$role->role_name}}" value="{{$role->id}}"
