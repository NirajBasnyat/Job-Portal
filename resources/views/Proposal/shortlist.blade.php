                                            ...
                                            @foreach($applicants as $applicant)
                                                <tr>
                                                    @if(!empty($applicant->avatar))
                                                        <td class="text-center" ><img src="/storage/Avatar/{{ $applicant->avatar }}" class="p-0 rounded-circle" style="height: 80px"></td>
                                                    @else
                                                        <td class="text-center" ><i class="fas fa-user-circle fa-6x text-muted"></i></td>
                                                    @endif
                                                        <td class="text-nowrap"><h5 class="h5"> <a class="text-info" href="{{route('applicant_view',$applicant->id)}}">{{ $applicant->name }}</a></h5>
                                                    ...
                                                    @else
                                                        <td>
                                                            <a href="/proposal/{{ $job->id }}/{{$applicant->id}}/hire" class="btn btn-sm btn-outline-success">
                                                                <i class="fas fa-thumbs-up"></i> Hire Candidate
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="/proposal/{{ $job->id }}/{{$applicant->id}}/reject" class="btn btn-sm btn-outline-danger">
