...
<nav id="sidebar" style="background:#343a40;">
    <div class="sidebar-header p-0 m-0">
        <a href="{{route('index')}}"><img src="{{asset('images/logo_main.png')}}" alt="Logo" height="120px"
                width="120px" class="side_profile" /></a>
        <strong><img src="{{asset('images/logo_raw.png')}}" alt="Logo" height="50px" width="50px"
                class="mb-3" /></strong>
        <div class="row pl-5">
            <h5 class="float-left m-0 text-info side_profile text-center"><small> Welcome{{Auth::user()->name}} </small>
            </h5>
        </div>
