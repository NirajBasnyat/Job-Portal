                                ...
                                <table class="table table-striped">
                                    ...
                                    @foreach($testimonials as $testimonial)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('testimonial.edit',$testimonial->id)}}"><i class="far fa-edit text-info"></i></a>
                                            </td>
                                            <td>
                                            ...
                                            @if(auth()->user()->admin)
                                                @if($testimonial->approved)
                                                    <td><a href="{{route('testimonial.disapprove',$testimonial->id)}}" class="btn btn-sm btn-outline-success">Disapprove</a></td>
                                                @else
                                                    <td><a href="{{route('testimonial.approve',$testimonial->id)}}" class="btn btn-sm btn-green">Approve</a></td>
                                                @endif
                                            @endif
                                        </tr>
                                    @endforeach
                                    @else
                                        <p class="mt-5 text-center mb-5">You don't have any testimonial post</p>
                                    @endif
                                    </tbody>
                                </table>
                        </div>
