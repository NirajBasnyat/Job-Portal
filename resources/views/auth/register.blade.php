                ...
                <div class="card mx-auto animated pulse" id="login-card">
                    <div class="card-body mt-3">
                        <form class="custom-hover" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="roles" class="gray">User Role</label>
                                <select id="roles" name="role" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <button type="submit" class="btn btn-green float-right" onclick="anim()">Register</button>
                                </div>
                            </div>
                            <hr>
