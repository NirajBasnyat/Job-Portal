                                ...
                                <form action="{{route('application_store',$job->id)}}" method="POST">
                                    ...
                                    <div class="card-body pt-0 table-responsive py-3">
                                        <div class="form-group">
                                            <label for="article-ckeditor">Tell something about yourself</label>
                                            <textarea name="application_letter" class="form-control" id="article-ckeditor" rows="8">{{old('application_letter')}}</textarea>
                                        </div>
                                    </div>
