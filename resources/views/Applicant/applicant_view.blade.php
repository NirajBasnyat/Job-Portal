                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12 text-center">
                                            @if(!empty($profile->avatar))
                                                <img class="p-0 rounded-circle" src="/storage/Avatar/{{$profile->avatar}}" >
                                            @else
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <small class="h6 text-muted"><i class="fas fa-map-marker-alt"></i>  {{$profile !== null ? $profile->city.', '.$profile->country : ''}}</small>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
